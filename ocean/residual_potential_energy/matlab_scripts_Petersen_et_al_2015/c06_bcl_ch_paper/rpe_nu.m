...
%dir={'c06'}; abc='abcde'; dims=1*[16  58]; 
dir={'c12'}; abc='pqrstuvwxy'; dims=1*[40 143]; 
nu_h=[1 5 10 20 200];

%time_fields=[1:13];
%dir={'c07'}; abc='dest'; dims=1*[40 143]; 
%nu_h=[20 200];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% RPE with time, many viscosities 1 km
...
%%%%%% plot dRPE/dt versus grid Reynolds number 10 km
