...
dir={'m62'}; abc='qmnop'; dims=1*[160 576];
nu_h=[1 5 10 20 200];
grid_spacing=1e3;
...
dir={'m62'}; abc='abcderstuv'; dims=1*[16 56];
...
dir={'m62'}; abc='ghijkwxyzZ'; dims=1*[40 143]; % change after m51k is done
nu_h=[1 5 10 20 200];
grid_spacing=4e3;
time_fields=[1:11];min_n=1;max_n = 11;
...
set(h,'MarkerFaceColor',blue,'Color',blue);
