...
for j=1:1
  ...
  h=loglog(gridRe,meanDrpeDt1km100day(iBeg:iEnd),'k*-');
  set(h,'Marker',marker(2),'LineWidth',1)
...
kmt_file = 'kmt_BCC_1kms.da';
grid_file = 'grid_BCC_1kms.da';
