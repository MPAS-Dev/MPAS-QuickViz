...
ax.set_title('$F_{\mathrm{ovS}}$ and azonal (gyre) component ($F_{\mathrm{azS}}$), E3SM Arctic')
...
ax.set_title('Atlantic Surface Water (ASW), E3SM Arctic')
...
ax.set_title('Antarctic Intermediate Water (AIW), E3SM Arctic')
...
ax.set_title('North Atlantic Deep Water (NADW), E3SM Arctic')
...
ax.set_title('Antarctic Bottom Water (ABW), E3SM Arctic')
