...
ax.set_title('Meridional velocity, E3SM Arctic ('+str(year_start)+' - '+str(year_end)+')')
...
ax.set_title('Salinity, E3SM Arctic ('+str(year_start)+' - '+str(year_end)+')')
...
ax.set_title('Freshwater transport, E3SM Arctic ('+str(year_start)+' - '+str(year_end)+')')
