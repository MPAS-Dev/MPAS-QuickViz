...
ax.set_title('$F_{\mathrm{ovS}}$ and azonal (gyre) component ($F_{\mathrm{azS}}$), LR-E3SM')
...
ax.set_title('Atlantic Surface Water (ASW), LR-E3SM')
...
ax.set_title('Antarctic Intermediate Water (AIW), LR-E3SM')
...
ax.set_title('North Atlantic Deep Water (NADW), LR-E3SM')
...
ax.set_title('Antarctic Bottom Water (ABW), LR-E3SM')
